import { shallowRef, unref, computed, reactive, nextTick, defineComponent, inject, h, provide, ref, watch, getCurrentInstance, watchEffect, resolveComponent, resolveDirective, openBlock, createElementBlock, normalizeClass, normalizeStyle, createElementVNode, Fragment, createBlock, withCtx, withDirectives, createCommentVNode, toDisplayString, resolveDynamicComponent, createVNode, Transition, mergeProps, renderList, renderSlot, createTextVNode, withAsyncContext, Teleport, Suspense } from 'vue';
import { s as setupDevtoolsPlugin, c as createI18n } from './form-1144cc11.mjs';
import { F as FilterMatchMode } from './dropdown.esm-42467633.mjs';
import { l as loadSiteMap, g as getRoutesByProfile, a as getDefaultRoute, c as createClient } from './routes-c7b670d2.mjs';
import { c as configs, i as initConfigs } from './configs-be955862.mjs';
import { O as OverlayEventBus, s as script$6 } from './portal.esm-7deedf95.mjs';
import { Z as ZIndexUtils, D as DomHandler, C as ConnectedOverlayScrollHandler, U as UniqueComponentId, O as ObjectUtils } from './utils.esm-d009df4f.mjs';
import { R as Ripple } from './ripple.esm-9120ee72.mjs';
import { s as script$8 } from './inputtext.esm-98b20197.mjs';
import { s as script$7 } from './login-2eb7330b.mjs';
import { s as styleInject$1 } from './style-inject.es-04d8aa40.mjs';
import { c as clearDataCache, a as createDataStore } from './fieldset.esm-bceed8ae.mjs';
import { c as clearStores } from './reactivestores-e540cb98.mjs';
import { s as script$a } from './repo-245a8d6a.mjs';
import { s as script$9 } from './active-92a8c876.mjs';
import { s as script$b } from './sitemap-e6c02eb3.mjs';
import { s as script$c } from './missing-page-989bd88a.mjs';
import './focustrap.esm-2e0fe540.mjs';
import './dispatch-response-339e84f1.mjs';
import './card.esm-aa1399ba.mjs';
import './panel.esm-0904c2bd.mjs';
import './tree-3766f819.mjs';
import './table-195bb781.mjs';
...
import './edit-action-61488f7b.mjs';
import './move-action-7538dcd6.mjs';
import './slug-trail-f5b35e84.mjs';
import './show-audit-23c30089.mjs';
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return $options.visible() ? (openBlock(), createElementBlock("li", {
    ...
    }, null, 2)) : createCommentVNode("", true), createElementVNode("span", _hoisted_3$1, toDisplayString($options.label()), 1)], 10, _hoisted_2$1)), [[_directive_ripple]])]),
    _: 1
    ...
    key: 0,
    class: normalizeClass(['p-menuitem-icon', $props.item.icon])
  }, null, 2)) : createCommentVNode("", true), createElementVNode("span", _hoisted_5, toDisplayString($options.label()), 1)], 10, _hoisted_4)), [[_directive_ripple]])], 64)) : (openBlock(), createBlock(resolveDynamicComponent($props.template), {
    key: 1,
    item: $props.item
  }, null, 8, ["item"]))])], 14, _hoisted_1$1)) : createCommentVNode("", true);
}
    ...
    default: withCtx(() => [createVNode(Transition, {
      ...
      default: withCtx(() => [($props.popup ? $data.overlayVisible : true) ? (openBlock(), createElementBlock("div", mergeProps({
        ...
        return openBlock(), createElementBlock(Fragment, {
          ...
          item: item
        }, () => [createTextVNode(toDisplayString($options.label(item)), 1)])], 8, _hoisted_3)) : createCommentVNode("", true), (openBlock(true), createElementBlock(Fragment, null, renderList(item.items, (child, j) => {
          return openBlock(), createElementBlock(Fragment, {
      ...
      }), 128))], 40, _hoisted_2$2)], 16, _hoisted_1$2)) : createCommentVNode("", true)]),
      _: 3
...
script$4.__file = "presstojam/src/components/routes.vue";

const _hoisted_1 = { key: 1 };
const _hoisted_2 = { class: "ptj-users" };
...
(
  ([__temp,__restore] = withAsyncContext(() => client.switchTokens()
.then(() => {
    return client.get("/user/check-user")
}).then(response => {
    if (response.name != _profile) {
...
return (_ctx, _cache) => {
  return (require_login.value)
    ? (openBlock(), createBlock(script$7, { key: 0 }))
    : (openBlock(), createElementBlock("div", _hoisted_1, [
        (openBlock(), createBlock(Teleport, { to: unref(teleport) }, [
          createElementVNode("div", _hoisted_2, [
            createVNode(unref(script$8), {
              ...
              default: withCtx(() => [
                createTextVNode(toDisplayString(name.value), 1 /* TEXT */)
              ]),
              _: 1 /* STABLE */
            }),
...
script$3.__file = "presstojam/src/components/user.vue";
...
script$2.__file = "presstojam/src/components/controller.vue";
...
const component = computed(() => {
    return (props.is_active) ? script$9 : script$a;
});
...
return (_ctx, _cache) => {
  return (openBlock(), createElementBlock("div", null, [
    (openBlock(), createBlock(resolveDynamicComponent(unref(component)), { model: __props.model }, null, 8 /* PROPS */, ["model"]))
  ]))
}
}
...
script$1.__file = "presstojam/src/components/model.vue";

var script = {
  setup(__props) {

const base = configs.get("base");
location.href = base + "/data/" + getDefaultRoute();
...
script.__file = "presstojam/src/components/setdefault.vue";
...
var index = {
  install: (app, options) => {
    ...
    const croutes = options.routes ? options.routes : []; //add base
    ...
    app.component("Controller", script$2);
  }
};

export { script$2 as Controller, index as default };
