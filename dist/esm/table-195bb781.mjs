import { resolveComponent, openBlock, createBlock, withCtx, createVNode, unref, inject, onMounted, createElementBlock, normalizeClass, withKeys, withModifiers, createElementVNode, resolveDirective, normalizeStyle, resolveDynamicComponent, toDisplayString, createCommentVNode, Fragment, withDirectives, createTextVNode, renderList, Transition, renderSlot, createSlots, mergeProps, ref, computed, isRef, pushScopeId, popScopeId, watch } from 'vue';
import { s as script$r } from './card.esm-aa1399ba.mjs';
import { b as FilterOperator, c as FilterService, F as FilterMatchMode, d as script$h, a as script$i } from './dropdown.esm-42467633.mjs';
import { a as createRepoStore, r as regStore, g as getStore } from './reactivestores-e540cb98.mjs';
import { s as script$f, a as script$m } from './inputtext.esm-98b20197.mjs';
import { u as useI18n, e as script$k, a as script$l, d as script$o } from './form-1144cc11.mjs';
import { a as createDataStore, b as createTemporaryStore } from './fieldset.esm-bceed8ae.mjs';
import { s as script$s } from './view-field-0425b8ce.mjs';
import { s as script$g, a as script$q } from './pagination-c43fca32.mjs';
import { O as ObjectUtils, D as DomHandler, U as UniqueComponentId, Z as ZIndexUtils, C as ConnectedOverlayScrollHandler } from './utils.esm-d009df4f.mjs';
import { O as OverlayEventBus, s as script$j } from './portal.esm-7deedf95.mjs';
import { R as Ripple } from './ripple.esm-9120ee72.mjs';
import { s as script$n, a as script$p } from './filter-form-fbb35642.mjs';
import { i as getLabel, s as saveOrder } from './routes-c7b670d2.mjs';
...
script$d.__file = "presstojam/src/components/actions/primary-action.vue";
...
script$c.__file = "presstojam/src/components/effects/audit.vue";
...
function render$a(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, _hoisted_3$6, 10, _hoisted_1$a)], 34);
}
...
const _hoisted_2$6 = /*#__PURE__*/createElementVNode("span", {
...
function render$8(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return $options.loading ? (openBlock(), createElementBlock("td", {
    ...
    role: "cell"
  }, [$props.responsiveLayout === 'stack' ? (openBlock(), createElementBlock("span", _hoisted_1$8, toDisplayString($options.columnProp('header')), 1)) : createCommentVNode("", true), $props.column.children && $props.column.children.body && !$data.d_editing ? (openBlock(), createBlock(resolveDynamicComponent($props.column.children.body), {
    key: 1,
    data: $props.rowData,
    column: $props.column,
    field: $options.field,
    ...
    type: "button"
  }, _hoisted_3$5)), [[_directive_ripple]]) : createCommentVNode("", true), $data.d_editing ? withDirectives((openBlock(), createElementBlock("button", {
    key: 1,
    class: "p-row-editor-save p-link",
    onClick: _cache[4] || (_cache[4] = (...args) => $options.onRowEditSave && $options.onRowEditSave(...args)),
    type: "button"
  }, _hoisted_5$3)), [[_directive_ripple]]) : createCommentVNode("", true), $data.d_editing ? withDirectives((openBlock(), createElementBlock("button", {
    key: 2,
    class: "p-row-editor-cancel p-link",
    onClick: _cache[5] || (_cache[5] = (...args) => $options.onRowEditCancel && $options.onRowEditCancel(...args)),
    type: "button"
  }, _hoisted_7$1)), [[_directive_ripple]]) : createCommentVNode("", true)], 64)) : (openBlock(), createElementBlock(Fragment, {
    key: 8
  }, [createTextVNode(toDisplayString($options.resolveFieldData()), 1)], 64))], 38));
}
...
function render$7(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("tbody", {
    ...
    return openBlock(), createElementBlock(Fragment, {
    ...
    }, null, 2)], 8, _hoisted_2$5)) : createCommentVNode("", true), (openBlock(), createBlock(resolveDynamicComponent($props.templates['groupheader']), {
      data: rowData,
      index: $options.getRowIndex(index)
    }, null, 8, ["data", "index"]))], 8, _hoisted_1$7)], 4)) : createCommentVNode("", true), ($props.expandableRowGroups ? $options.isRowGroupExpanded(rowData) : true) ? (openBlock(), createElementBlock("tr", {
    ...
    }), 128))], 46, _hoisted_3$4)) : createCommentVNode("", true), $props.templates['expansion'] && $props.expandedRows && $options.isRowExpanded(rowData) ? (openBlock(), createElementBlock("tr", {
      ...
      data: rowData,
      index: $options.getRowIndex(index)
    }, null, 8, ["data", "index"]))], 8, _hoisted_4$3)])) : createCommentVNode("", true), $props.templates['groupfooter'] && $props.rowGroupMode === 'subheader' && $options.shouldRenderRowGroupFooter($props.value, rowData, $options.getRowIndex(index)) ? (openBlock(), createElementBlock("tr", {
  ...
  }), 128)) : (openBlock(), createElementBlock("tr", _hoisted_5$2, [createElementVNode("td", {
    colspan: $options.columnsLength
  }, [$props.templates.empty ? (openBlock(), createBlock(resolveDynamicComponent($props.templates.empty), {
    key: 0
  })) : createCommentVNode("", true)], 8, _hoisted_6$2)]))], 4);
}
...
function render$6(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("td", {
    ...
    key: 0,
    column: $props.column
  }, null, 8, ["column"])) : createCommentVNode("", true), createTextVNode(" " + toDisplayString($options.columnProp('footer')), 1)], 14, _hoisted_1$6);
}
...
function render$5(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return $options.hasFooter ? (openBlock(), createElementBlock("tfoot", _hoisted_1$5, [!$props.columnGroup ? (openBlock(), createElementBlock("tr", _hoisted_2$4, [(openBlock(true), createElementBlock(Fragment, null, renderList($props.columns, (col, i) => {
    return openBlock(), createElementBlock(Fragment, {
      key: $options.columnProp(col, 'columnKey') || $options.columnProp(col, 'field') || i
...
const _hoisted_3$3 = /*#__PURE__*/createElementVNode("span", {
...
const _hoisted_6$1 = [_hoisted_5$1$1];
const _hoisted_7 = {
  key: 0,
...
const _hoisted_9 = /*#__PURE__*/createElementVNode("li", {
...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
    class: normalizeClass($options.containerClass)
  }, [$props.display === 'row' ? (openBlock(), createElementBlock("div", _hoisted_1$3, [(openBlock(), createBlock(resolveDynamicComponent($props.filterElement), {
    field: $props.field,
  ...
  }, _hoisted_4$2, 42, _hoisted_2$3)) : createCommentVNode("", true), $props.showClearButton && $props.display === 'row' ? (openBlock(), createElementBlock("button", {
    key: 2,
  ...
  }, _hoisted_6$1, 2)) : createCommentVNode("", true), createVNode(_component_Portal, null, {
    default: withCtx(() => [createVNode(Transition, {
      ...
      default: withCtx(() => [$data.overlayVisible ? (openBlock(), createElementBlock("div", {
        ...
        filterModel: $props.filters[$props.field],
        filterCallback: $options.filterCallback
      }, null, 8, ["field", "filterModel", "filterCallback"])), $props.display === 'row' ? (openBlock(), createElementBlock("ul", _hoisted_7, [(openBlock(true), createElementBlock(Fragment, null, renderList($options.matchModes, (matchMode, i) => {
      ...
      }), 128)), _hoisted_9, createElementVNode("li", {
      ...
      }, toDisplayString($options.noFilterLabel), 33)])) : (openBlock(), createElementBlock(Fragment, {
        key: 1
      }, [$options.isShowOperator ? (openBlock(), createElementBlock("div", _hoisted_10, [createVNode(_component_CFDropdown, {
        ...
        optionLabel: "label",
        optionValue: "value"
      }, null, 8, ["options", "modelValue"])])) : createCommentVNode("", true), createElementVNode("div", _hoisted_11, [(openBlock(true), createElementBlock(Fragment, null, renderList($options.fieldConstraints, (fieldConstraint, i) => {
        return openBlock(), createElementBlock("div", {
          key: i,
      ...
      }), 128))]), $options.isShowAddConstraint ? (openBlock(), createElementBlock("div", _hoisted_12, [createVNode(_component_CFButton, {
        type: "button",
        label: $options.addRuleButtonLabel,
        icon: "pi pi-plus",
        class: "p-column-filter-add-button p-button-text p-button-sm",
        onClick: _cache[8] || (_cache[8] = $event => $options.addConstraint())
      }, null, 8, ["label"])])) : createCommentVNode("", true), createElementVNode("div", _hoisted_13, [!$props.filterClearTemplate && $props.showClearButton ? (openBlock(), createBlock(_component_CFButton, {
        key: 0,
        type: "button",
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("th", {
    ...
    key: 0,
    column: $props.column
  }, null, 8, ["column"])) : createCommentVNode("", true), $options.columnProp('header') ? (openBlock(), createElementBlock("span", _hoisted_3$2$1, toDisplayString($options.columnProp('header')), 1)) : createCommentVNode("", true), $options.columnProp('sortable') ? (openBlock(), createElementBlock("span", {
    key: 2,
    class: normalizeClass($options.sortableColumnIcon)
  }, null, 2)) : createCommentVNode("", true), $options.isMultiSorted() ? (openBlock(), createElementBlock("span", _hoisted_4$1$1, toDisplayString($options.getBadgeValue()), 1)) : createCommentVNode("", true), $options.columnProp('selectionMode') === 'multiple' && $props.filterDisplay !== 'row' ? (openBlock(), createBlock(_component_DTHeaderCheckbox, {
    key: 4,
...
function render$b(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
    ...
    fn: withCtx(() => [renderSlot(_ctx.$slots, "paginatorend")]),
    key: "1"
  } : undefined]), 1032, ["rows", "first", "totalRecords", "pageLinkSize", "template", "rowsPerPageOptions", "currentPageReportTemplate", "alwaysShow"])) : createCommentVNode("", true), _ctx.$slots.footer ? (openBlock(), createElementBlock("div", _hoisted_3$7, [renderSlot(_ctx.$slots, "footer")])) : createCommentVNode("", true), createElementVNode("div", _hoisted_4$5, null, 512), $props.reorderableColumns ? (openBlock(), createElementBlock("span", _hoisted_5$4, null, 512)) : createCommentVNode("", true), $props.reorderableColumns ? (openBlock(), createElementBlock("span", _hoisted_6, null, 512)) : createCommentVNode("", true)], 2);
}
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, [createElementVNode("div", _hoisted_2$2, [renderSlot(_ctx.$slots, "start")]), createElementVNode("div", _hoisted_3$2, [renderSlot(_ctx.$slots, "end")])], 8, _hoisted_1$2);
}
...
script$5.__file = "presstojam/src/components/actions/export-action.vue";
...
script$4.__file = "presstojam/src/components/actions/create-action.vue";

const _hoisted_1$1 = /*#__PURE__*/createElementVNode("p", null, "Are you sure you want to delete:", -1 /* HOISTED */);
const _hoisted_2$1 = /*#__PURE__*/createTextVNode("Type ");
const _hoisted_3$1 = /*#__PURE__*/createTextVNode(" in the box below");
const _hoisted_4$1 = { class: "p-inputgroup" };
const _hoisted_5$1 = /*#__PURE__*/createTextVNode("Delete");
...
return (_ctx, _cache) => {
  return (openBlock(), createElementBlock(Fragment, null, [
    ...
    createVNode(unref(script$k), {
      ...
      header: 'Delete ' + _ctx.$t('models.' + unref(repo).store.model + '.title', (__props.single) ? 1 : 2),
      modal: true,
      class: "p-fluid"
    }, {
      default: withCtx(() => [
        ...
        createElementVNode("p", null, [
          _hoisted_2$1,
          createElementVNode("i", null, toDisplayString(check_str)),
          _hoisted_3$1
        ]),
...
script$3.__file = "presstojam/src/components/actions/delete-action.vue";

const _withScopeId = n => (pushScopeId("data-v-29f6384d"),n=n(),popScopeId(),n);
const _hoisted_1 = /*#__PURE__*/createTextVNode("New row created");
const _hoisted_2 = /*#__PURE__*/createTextVNode("Rows removed");
const _hoisted_3 = {
  key: 0,
  class: "p-input-icon-left mr-2"
};
const _hoisted_4 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/createElementVNode("i", { class: "pi pi-search" }, null, -1 /* HOISTED */));
...
return (_ctx, _cache) => {
  return (openBlock(), createElementBlock(Fragment, null, [
    (unref(repo).pagination && !unref(store).route.settings.nofilter)
    ...
    (delrow.value)
      ...
      : createCommentVNode("v-if", true),
    createVNode(unref(script$6), { class: "mb-4" }, {
      start: withCtx(() => [
        (!unref(repo).pagination)
    ...
    (unref(repo).pagination)
      ? (openBlock(), createElementBlock("p", _hoisted_5, "Total Rows: " + toDisplayString(unref(repo).pagination.count), 1 /* TEXT */))
      : createCommentVNode("v-if", true),
    createVNode(script, {
      ref_key: "dt",
      ref: dt,
    ...
    }, null, 8 /* PROPS */, ["name", "fields", "search"]),
    (unref(repo).pagination)
      ? (openBlock(), createBlock(script$q, {
          key: 4,
          pagination: unref(repo).pagination,
          onReload: reloadPage
...
script$2.__scopeId = "data-v-29f6384d";
script$2.__file = "presstojam/src/components/table/table-display.vue";
...
script$1.__file = "presstojam/src/components/table/child-table.vue";
...
return (_ctx, _cache) => {
  return (openBlock(), createElementBlock("div", {
    ...
    createVNode(unref(script$b), mergeProps({
      value: unref(repo).data.value,
      selection: unref(repo).selected.value,
      "onUpdate:selection": _cache[0] || (_cache[0] = $event => ((unref(repo).selected.value) = $event)),
      dataKey: "--id",
      rowClass: rowClass,
      responsiveLayout: "stack",
      loading: unref(repo).is_loading.value,
      rowHover: true,
      onRowReorder: onRowReorder,
      onRowExpand: onRowExpand,
      onRowCollapse: onRowCollapse,
      expandedRows: expandedRows.value,
      "onUpdate:expandedRows": _cache[1] || (_cache[1] = $event => ((expandedRows).value = $event)),
      globalFilterFields: global_filter_fields,
      filters: unref(filters)
    }, atts), createSlots({
      expansion: withCtx((slotProps) => [
        createVNode(unref(script$r), null, {
          title: withCtx(() => [
            createTextVNode(toDisplayString(_ctx.$t("models." + unref(store).route.children[0] + ".title")), 1 /* TEXT */)
          ]),
          content: withCtx(() => [
            (openBlock(), createBlock(script$1, {
              name: unref(store).route.children[0],
              parent_id: slotProps.data['--id'],
              key: slotProps.data['--id']
            }, null, 8 /* PROPS */, ["name", "parent_id"]))
          ]),
          _: 2 /* DYNAMIC */
        }, 1024 /* DYNAMIC_SLOTS */)
      ]),
      default: withCtx(() => [
        ...
        (unref(store).route.perms.includes('delete'))
          ...
          : createCommentVNode("v-if", true),
        (openBlock(true), createElementBlock(Fragment, null, renderList(__props.fields, (cell) => {
          ...
          body: withCtx((slotProps) => [
            ...
            (unref(store).route.perms.includes('put'))
              ? (openBlock(), createBlock(unref(script$f), {
                  ...
                  icon: "pi pi-pencil",
                  class: "p-button-rounded p-button-success mr-2",
                  onClick: $event => (showEdit(slotProps.data))
            ...
            (unref(store).route.audit)
              ? (openBlock(), createBlock(unref(script$f), {
                  ...
                  onClick: $event => (showAudit(slotProps.data))
                }, null, 8 /* PROPS */, ["onClick"]))
              : createCommentVNode("v-if", true),
      ...
      (atts.groupRowsBy)
        ...
        : undefined
    ]), 1040 /* FULL_PROPS, DYNAMIC_SLOTS */, ["value", "selection", "loading", "expandedRows", "filters"]),
    (unref(store).route.audit)
      ? (openBlock(), createBlock(unref(script$k), {
          key: 0,
          visible: show_audit.value,
          "onUpdate:visible": _cache[2] || (_cache[2] = $event => ((show_audit).value = $event)),
          header: "Audit",
          modal: true,
          class: "p-fluid"
        }, {
    ...
    (unref(store).route.perms.includes('put'))
      ? (openBlock(), createBlock(unref(script$k), {
          key: 1,
          visible: show_edit.value,
          "onUpdate:visible": _cache[4] || (_cache[4] = $event => ((show_edit).value = $event)),
          header: 'Edit ' + _ctx.$t('models.' + unref(store).model + '.title', 1),
          modal: true,
          class: "p-fluid"
        }, {
          default: withCtx(() => [
            createVNode(script$l, {
              ...
              model: unref(store).model,
              onSaved: _cache[3] || (_cache[3] = $event => (hideEdit())),
...
script.__file = "presstojam/src/components/table/table.vue";

export { script$3 as a, script$6 as b, script$d as c, script$4 as d, script as e, script$c as f, script$5 as g, script$2 as s };
