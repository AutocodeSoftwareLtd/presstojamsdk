import { openBlock, createElementBlock, toDisplayString, resolveDirective, withDirectives, normalizeClass, resolveComponent, createBlock, Fragment, renderList, createTextVNode, renderSlot, createCommentVNode, createElementVNode, computed, unref } from 'vue';
import { U as UniqueComponentId } from './utils.esm-d009df4f.mjs';
import { R as Ripple } from './ripple.esm-9120ee72.mjs';
import { a as script$b, s as script$c } from './dropdown.esm-42467633.mjs';
...
const _hoisted_2$5 = [_hoisted_1$5];
...
function render$8(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return withDirectives((openBlock(), createElementBlock("button", {
    ...
    type: "button"
  }, _hoisted_2$5, 2)), [[_directive_ripple]]);
}
...
function render$5(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return withDirectives((openBlock(), createElementBlock("button", {
    class: normalizeClass($options.containerClass),
    type: "button"
  }, _hoisted_2$4, 2)), [[_directive_ripple]]);
}
...
const _hoisted_2$3 = [_hoisted_1$3];
...
function render$4(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return withDirectives((openBlock(), createElementBlock("button", {
    class: normalizeClass($options.containerClass),
    type: "button"
  }, _hoisted_2$3, 2)), [[_directive_ripple]]);
}
...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("span", _hoisted_1$2, [(openBlock(true), createElementBlock(Fragment, null, renderList($props.value, pageLink => {
    return withDirectives((openBlock(), createElementBlock("button", {
      key: pageLink,
    ...
    }, [createTextVNode(toDisplayString(pageLink), 1)], 10, _hoisted_2$2)), [[_directive_ripple]]);
  }), 128))]);
}
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return withDirectives((openBlock(), createElementBlock("button", {
    class: normalizeClass($options.containerClass),
    type: "button"
  }, _hoisted_2$1, 2)), [[_directive_ripple]]);
}
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return ($props.alwaysShow ? true : $options.pageLinks && $options.pageLinks.length > 1) ? (openBlock(), createElementBlock("div", _hoisted_1, [(openBlock(true), createElementBlock(Fragment, null, renderList($options.templateItems, (value, key) => {
    return openBlock(), createElementBlock("div", {
      key: key,
      ref_for: true,
      ref: "paginator",
      class: normalizeClass(["p-paginator p-component", $options.getPaginatorClasses(key)])
    }, [_ctx.$slots.start ? (openBlock(), createElementBlock("div", _hoisted_2, [renderSlot(_ctx.$slots, "start", {
    ...
    }), 128)), _ctx.$slots.end ? (openBlock(), createElementBlock("div", _hoisted_3, [renderSlot(_ctx.$slots, "end", {
      state: $options.currentState
...
return (_ctx, _cache) => {
  return (openBlock(), createBlock(unref(script$a), {
    rows: __props.pagination.rows_per_page,
    totalRecords: parseInt(__props.pagination.count),
    paginatorTemplate: "FirstPageLink PrevPageLink PageLinks NextPageLink LastPageLink CurrentPageReport RowsPerPageDropdown",
    currentPageReportTemplate: "Showing {first} to {last} of {totalRecords}",
    onPage: _cache[0] || (_cache[0] = $event => (onPage($event)))
  }, null, 8 /* PROPS */, ["rows", "totalRecords"]))
}
}

};

script.__file = "presstojam/src/components/paginator/pagination.vue";

export { script as a, script$a as s };
