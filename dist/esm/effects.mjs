import { f as script } from './table-195bb781.mjs';
export { f as Audit } from './table-195bb781.mjs';
import { s as script$1 } from './move-action-7538dcd6.mjs';
export { s as MoveAction } from './move-action-7538dcd6.mjs';
import 'vue';
...
var index = {
  install(Vue) {
    Vue.component("Audit", script);
    Vue.component("MoveAction", script$1);
  }
