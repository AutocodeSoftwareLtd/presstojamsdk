...
export function createAppRouter() {
    ...
    croutes.push({ path : base + "/data/:model/:id?", component : Repo, name : 'repo', props : route => ({ model : route.params.model, id : route.params.id })});
    croutes.push({ path : base + "/data/active/:model/:id", component : Active, name : 'primary', props : route => ({ model : route.params.model, is_active : true, id : route.params.id }) });
